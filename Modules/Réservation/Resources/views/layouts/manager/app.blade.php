    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="nav-link {{ request()->is('reservation/clients*') ? 'active' : '' }} "
                        href="{{ '/reservation/clients' }}">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="nav-link {{ request()->is('reservation/reservations*') ? 'active' : '' }} "
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="nav-link {{ request()->is('reservation/admins*') ? 'active' : '' }} "
                        href="{{ '/reservation/admins' }}">
                        <div class="d-flex align-items-center"><i class="nav-icon fas fa-users"></i>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link  {{ request()->is('reservation/clients*') ? 'active' : '' }} ">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{ 'reservation/clients' }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Liste des clients</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ 'reservation/users/create' }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Crée une client</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link  {{ request()->is('reservation/reservations*') ? 'active' : '' }} ">
                        ...
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link  {{ request()->is('reservation/admins*') ? 'active' : '' }} ">
                                <i class="nav-icon fas fa-users"></i>
                                <p>
                                    Utilisateurs
                                    <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{ 'reservation/admins' }}" class="nav-link  ">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <ul class="nav nav-bottom nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <li class="nav-item mt-auto">
                            <a href="{{ url('reservation/statistiques') }}"
                                class="nav-link  {{ request()->is('reservation/statistiques*') ? 'active' : '' }} ">
                                <i class="nav-icon fas fa-chart-bar"></i>
                                <p>Statistiques</p>
                            </a>
                        </li>
