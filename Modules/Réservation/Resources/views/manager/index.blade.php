            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="{{ 'reservation/clients' }}" class="small-box-footer">Plus d'info <i
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        ...
                        <a href="{{ 'reservation/chambres' }}" class="small-box-footer">Plus d'info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        ...
                        <a href="{{ 'reservation/reservations' }}" class="small-box-footer">Plus d'info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        ...
                        <a href="{{ 'reservation/demandes' }}" class="small-box-footer">Plus d'info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-indigo">
                        ...
                        <a href="{{ 'reservation/admins' }}" class="small-box-footer">Plus d'info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-pink">
                        ...
                        <a href="{{ 'reservation/commentaires' }}" class="small-box-footer">Plus d'info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-purple">
                        ...
                        <a href="{{ 'reservation/services' }}" class="small-box-footer">Plus d'info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-lime">
                        ...
                        <a href="{{ 'reservation/messages' }}" class="small-box-footer">Plus d'info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
