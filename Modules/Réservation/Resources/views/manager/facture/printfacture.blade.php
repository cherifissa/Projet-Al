        ...
        <div class="row">
            <div class="col-12">
                <div class="callout callout-info">
                    ...
                    Cette page a été améliorée pour l'impression. Cliquez sur le bouton Imprimer en bas de la facture
                    pour
                    imprimmer la facure.
                </div>
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
                                Payer à la reception svp!
                            </p>
                        </div>
                        <!-- /.col -->
                        <div class="col-6">
                            <p class="lead">Montant dû {{ $date }}</p>
                                    ...
                                    <tbody>
                                        ...
                                        @if ($reservation->paye == 1)
                                            <tr>
                                                bbb
                                                <th>Payé</th>
                                                <td>{{ $totalPrixservice + $reservation->prix }} FCFA</td>
                                            </tr>
                                            <tr>
                                                <th>Total à payer</th>
                                                <td>0 FCFA</td>
                    ...
                    <div class="row no-print">
                        <div class="col-12">
                            <a href="{{ route('reservations.index') }}" rel="noopener"
                                class="btn btn-success float-right""><i class="fas fa-back"></i> Retourner</a>
