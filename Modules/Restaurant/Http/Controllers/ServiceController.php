...
class ServiceController extends Controller
{
    public function index()
    {
        ...
        return view('réservation::manager.services.index', ['services' => $services]);
    }
    public function create()
    {
        $reservations = Reservation::all();
        return view('réservation::manager.services.create', ['reservations' => $reservations]);
    }
    ...
    {
        return view('réservation::manager.services.edit', compact('service'));
    }
