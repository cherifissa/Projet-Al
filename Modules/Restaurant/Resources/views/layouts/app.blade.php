    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="nav-link {{ request()->is('restaurant/servicesresto*') ? 'active' : '' }} "
                        href="/restaurant/servicesresto">
                        <div class="d-flex align-items-center"> <i class="nav-icon fa fa-bookmark"></i>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link  {{ request()->is('restaurant/clients*') ? 'active' : '' }} ">
                        ...
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link  {{ request()->is('restaurant/servicesresto*') ? 'active' : '' }} ">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{ route('servicesresto.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
