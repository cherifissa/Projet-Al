                ...
                <div class="row">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <form class="form-horizontal" method="POST"
                                    action="{{ route('profileclt.update', $user->id) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <button type="submit" class="btn btn-primary btn-danger"><b>Mettre à
                                            jour</b></button>
                                </form>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                <form class="form-horizontal" method="POST"
                                    action="{{ route('changeasswordclt', $user->id) }}">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label for="inputPasswordConfirmation" class="col-sm-2 col-form-label">Confirmation
                                            du
                                            mot de passe</label>
                                        <div class="col-sm-10">
