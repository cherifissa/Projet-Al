        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-7 col-sm-6">
                    ...
                    <div id="carousel">
                        <figure id="spinner">
                            ...
                            <img src="{{ asset('images/litavetablepc.jpg') }}">
                            <img src="{{ asset('images/blog1.jpg') }}">
                            <img src="{{ asset('images/canapé.jpg') }}">
                            <img src="{{ asset('images/chaisesalon.jpg') }}">
                            <img src="{{ asset('images/chambre2lit.jpg') }}">
                ...
                <div class="col-md-5">
                    ...
                    <p class="text text-justify text-break lh-lg">{{ $chambreCategorie->description }}</p>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4>Autres</h4>
                        <ul class="list-group">
                            <li class="list-group-item"><i class="fas fa-housekeeping"></i> Service de ménage quotidien
                            </li>
